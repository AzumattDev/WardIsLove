...
namespace WardIsLove.PatchClasses
{
    ...
    {
        private static readonly MethodInfo TamedCheckAdder = AccessTools.DeclaredMethod(typeof(AllowTamedInNoMonsterArea), nameof(AddTamedCheck));
        private static readonly MethodInfo AreaChecker = AccessTools.DeclaredMethod(typeof(EffectArea), nameof(EffectArea.IsPointInsideArea));
